            ...
            {lang
                ...
                <>
                    ...
                    <p className="about-description" style={{ direction: 'ltr' }}>
                        ...
                        <li>Display the organizational chart, responsibilities, goals and tasks of central planning </li>
                ...
                <>
                    ...
                    <p className="about-description" style={{ direction: 'rtl' }} >
                        ...
                        <li>نمایش چارت سازمانی، مسئولیت ها، اهداف و وظایف برنامه ریزی مرکزی</li>
                    </p>
                </>
            }
        </>
