                ...
                <>
                    <div className="footer">
                        ...
                        <div className="contact">
                            ...
                            <Link className="contact-us about-sina" to='/api/about-hossein-zarei'> <FaInfoCircle style={{ color: '#0464f5' }} /> : About Hossein Zarei</Link>
                        </div>
                        <div>
                            <img className="lf-footer" src={INSIG} width={100} height={100} alt="Logo" />
                        </div>
