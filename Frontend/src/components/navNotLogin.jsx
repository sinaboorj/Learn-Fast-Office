        ...
        <>
            <nav className="main-nav-not-login">
                <ul className="nav-left">
                    <Link to='/api/login' className="log-item navlink" onClick={() => { login(); handleLinkClick('login') }} ><FontAwesomeIcon icon={faUserCircle} className={`login-icon ${activeLink === 'login' ? 'active' : ''}`} title="Login" /></Link>
                    {lang
